...
# Dummy wave function
input_wave = np.sin(np.linspace(0, 10*np.pi, 10000))
...
u_dot = np.cos(np.linspace(0, 10*np.pi, 10000)) # Derivative of wave function
...
# plt.plot(np.linspace(0, 10*np.pi, 10000), input_wave)
# plt.show()